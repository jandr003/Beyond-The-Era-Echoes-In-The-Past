...
export class CharacterSelection {
  ...
  _fireSpark(slot) {
    ...
    // Use requestAnimationFrame twice instead of forcing a reflow with
    // offsetWidth. This restarts the CSS animation without triggering
    // a synchronous layout across the page.
